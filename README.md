...
> [!IMPORTANT]
> ผู้พัฒนาจำเป็นต้องทำการบันทึกและอัปโหลดโค้ด (Push) ขึ้น GitHub ทุกครั้งเมื่อทำภารกิจหรือแก้ไขงานเสร็จสิ้น โดยสามารถสั่งการ Claude Code ด้วยภาษาธรรมชาติได้โดยตรง เช่น:
> * **กรณีที่ยังไม่มี Repository บน GitHub:** สามารถสั่งให้ Claude สร้าง repository ใหม่ได้ทันที เช่น พิมพ์บอกว่า *"สร้าง repository ใหม่บน GitHub ชื่อ [ชื่อโปรเจกต์] แบบ private และ push โค้ดขึ้นไป"*
> * **กรณีที่ต้องการบันทึกงานทั่วไป:** พิมพ์บอก Claude ในแชทว่า *"บันทึกงานและ push ขึ้น GitHub"* หรือ *"ช่วย push โค้ดทั้งหมดขึ้น GitHub ให้หน่อย"*
> * Claude จะทำการจัดการรันคำสั่ง Git (เช่น init, remote, add, commit, push) ที่จำเป็นให้โดยอัตโนมัติหลังจากที่คุณกดยืนยันการรันคำสั่ง (Approve)

---

## การแก้ปัญหาเบื้องต้น (Troubleshooting)

### ปัญหา: Agent is taking longer than expected to connect
กรณีที่ Workspace บน Coder แสดงข้อความแจ้งเตือนเกี่ยวกับการเชื่อมต่อของ Agent ล่าช้าหรือล้มเหลว:
1. **ตรวจสอบการตั้งค่า Firewall:** ตรวจสอบพอร์ตเครือข่ายของระบบเพื่อให้มั่นใจว่าพอร์ตการเชื่อมต่อสำหรับ Coder/Workspace ได้รับการอนุญาต (Open Firewall)
2. **การ Restart Workspace:** หากเปิดสิทธิ์การใช้งานพอร์ตเรียบร้อยแล้วแต่ยังเชื่อมต่อไม่ได้ ให้ทำการสั่งปิดแล้วเปิด Workspace ใหม่อีกครั้ง (Restart Workspace) ผ่านหน้า Dashboard Coder เพื่อให้ระบบทำการรีเซ็ตและเชื่อมต่อใหม่อีกครั้ง
