...
> * พิมพ์บอก Claude ในแชทว่า: *"บันทึกงานและ push ขึ้น GitHub"* หรือ *"ช่วย push โค้ดทั้งหมดขึ้น GitHub ให้หน่อย"*
> * Claude จะทำการจัดการรันคำสั่ง Git (เช่น add, commit, push) ที่จำเป็นให้โดยอัตโนมัติหลังจากที่คุณกดยืนยันการรันคำสั่ง (Approve)
